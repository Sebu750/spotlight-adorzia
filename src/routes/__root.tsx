...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Stop Interning. Start Competing. — Pakistan's Boldest Fashion Competition" },
      { property: "og:description", content: "100 shortlisted. 10 finalists. 1 winner. PKR 300K + 12 months funded production. Judged by HSY, Maheen Khan, Deepak Perwani, Nomi Ansari. Apply before July 15." },
      ...
      { name: "twitter:title", content: "Stop Interning. Start Competing. — SPOTLIGHT × ADORZIA" },
      { name: "twitter:description", content: "Pakistan's boldest fashion competition. PKR 300K + funded production for the next generation of designers. Apply by July 15." },
